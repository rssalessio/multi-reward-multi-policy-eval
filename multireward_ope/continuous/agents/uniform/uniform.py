...
class UniformAgent(Agent):
    ...
    def __init__(
        ...
        self._optimizer = torch.optim.AdamW(self._network.parameters(), config.lr_Q)
    ...
    def _gradient_step(self, batch: TorchTransitions):
        ...
        total_loss =   torch.nn.functional.mse_loss(q_values, target_q.detach())
    ...
    def make_default_agent(
            ...
            num_rewards: int,
            config: UniformConfig,
            device: torch.device) -> UniformAgent:
